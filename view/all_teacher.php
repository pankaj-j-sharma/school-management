  		...
  		xhttp.onreadystatechange = function() {
    		...
    		if (this.readyState == 4 && this.status == 200) {
				...
				if(lastPaid == 0){
					...
					document.getElementById('tSalary_lMonth').innerHTML = "No Data available";
					document.getElementById('lastPaid').innerHTML = "No Data available";
				}
				
				if(cSalary == 0){
					document.getElementById('currentSalary').innerHTML = "You have not any Classroom.";
					document.getElementById('currentPaid').innerHTML = "No Data available";
					document.getElementById('dueAmount').innerHTML = "No Data available";
