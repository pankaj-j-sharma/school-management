...
<div class="wrapper">
  <header class="main-header" >
    <!-- Logo -->
    <a href="" class="logo bg-green-gradient">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini bg-green-gradient"><strong>InC</strong></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg bg-green-gradient"><strong>InCampus IT </strong></span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top bg-green-gradient">
